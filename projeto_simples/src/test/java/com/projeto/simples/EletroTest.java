...
public class EletroTest {
    ...
    public static void main(String[] args) {
        ...
        //Geladeira c =new Geladeira("nome", "cor", "marca", "modelo", "12", 1, 21212, 22, 33.2);
